<footer class="navbar navbar-expand-lg navbar-light bg-light border-top1 mt-4">
    <div class="container">
        ...
        <a href="/"
            ...
            mb-3 mb-md-0 me-md-autolink-body-emphasis text-decoration-none">
        ...
        <ul class="navbar-nav col-md-4 justify-content-end">
            <li class="nav-item">
                <a href="index.html" class="nav-link px-2 footer-text">Beranda</a>
            </li>
            <li class="nav-item">
                <a href="jadwal_ibadah.html" class="nav-link px-2 footer-text">Jadwal Ibadah</a>
            </li>
            <li class="nav-item">
                <a href="#" class="nav-link px-2 footer-text">Renungan</a>
            </li>
            <li class="nav-item">
                <a href="#" class="nav-link px-2 footer-text">Sejarah</a>
            </li>
        </ul>
    </div>
</footer>
